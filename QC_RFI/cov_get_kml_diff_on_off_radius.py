...
CSV_FILE = r"E:\BIOMASS\02_DATA\14_RFI\COV_RFI_COMPARISON_ON_OFF.csv"
OUT_DIR  = r"E:\BIOMASS\02_DATA\14_RFI"
# ============================================================
# HELPERS
# ============================================================
...
# ============================================================
# REAL GEOSPATIAL CLUSTERING (1.7 km)
# ============================================================
...
eps = CLUSTER_KM / EARTH_RADIUS_KM   # radians
...
def radial_offset_m(base_lat, base_lon, i, n, radius_m=400):
...
for _, group in df.groupby("spatial_cluster"):
    ...
    # raggio cresce se cluster ha più prodotti
    radius_m = 11000.0 + 2000.0 * (n - 1)
...
for ch in channels:
    kml_abs[ch].save(f"{OUT_DIR}\\COV_ABS_{ch}_radius.kml")
    kml_phase[ch].save(f"{OUT_DIR}\\COV_PHASE_{ch}_radius.kml")
